...
#define ExtAnalyzer4_Pin GPIO_PIN_2
#define ExtAnalyzer4_GPIO_Port GPIOC
#define ExtAnalyzer3_Pin GPIO_PIN_3
#define ExtAnalyzer3_GPIO_Port GPIOC
...
#define ExtAnalyzer2_Pin GPIO_PIN_4
#define ExtAnalyzer2_GPIO_Port GPIOC
#define ExtAnalyzer1_Pin GPIO_PIN_5
#define ExtAnalyzer1_GPIO_Port GPIOC
...
#define LSM3DSL_DRDY_EXTI8_Pin GPIO_PIN_8
#define LSM3DSL_DRDY_EXTI8_GPIO_Port GPIOC
#define LSM3DSL_DRDY_EXTI8_EXTI_IRQn EXTI9_5_IRQn
